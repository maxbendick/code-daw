...
** document (compilation, parsing tokens, attaching zones, codeDawVars)
** TODO coolzone can choose which components to render
** TODO map between nodetype and token?
** TODO consider moving to one namespace only?
** put coolzone component inside superdef 🤯

...
** move to esmodules? need a way to adapt codeDawRequire
   ...
   const codeDawPackage = `
      export const sine = window.codeDawPackages['sine']
      export const saw = window.codeDawPackages['saw']
      export const simpleSequencer = window.codeDawPackages['simpleSequencer']
   `.encode()
